...
public class ListaCidadesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(estado.equals("Brasil")){
            ...
            client.get("http://" + this.ip_server + ":85/api2/cidade/getCidadesBrasil.php?dia=" + dataApp.getDia()+ "&mes=" + dataApp.getMes()+ "&ano="+ dataApp.getNo()
            ...
            client.get("http://" + this.ip_server + ":85/api2/cidade/getCidades.php?dia=" + dataApp.getDia()+ "&mes=" + dataApp.getMes()+ "&ano="+ dataApp.getNo()
